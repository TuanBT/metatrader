#!/usr/bin/env python3
"""
M15 Impulse FAG Entry EA v2.0 — M1 Timeframe Test
Tests XAUUSD M1 2024 + 2025 with various MTF filter settings.
M1 gives more IN/OUT signals within each M15 zone.
"""
...
DEPOSIT    = 500
LEVERAGE   = 100
RESULT_MD  = os.path.join(os.path.dirname(os.path.abspath(__file__)), "bt_m15_fag_m1_results.md")
...
TESTS = [
    ("XAUUSDm", "M1", "2025.01.01", "2026.02.01", "true",  "3", "M1 MinAg=3 2025"),
    ("XAUUSDm", "M1", "2024.01.01", "2025.01.01", "true",  "3", "M1 MinAg=3 2024"),
    ("XAUUSDm", "M1", "2025.01.01", "2026.02.01", "true",  "2", "M1 MinAg=2 2025"),
    ("XAUUSDm", "M1", "2024.01.01", "2025.01.01", "true",  "2", "M1 MinAg=2 2024"),
    ("XAUUSDm", "M1", "2025.01.01", "2026.02.01", "false", "3", "M1 NoFilter 2025"),
    ("XAUUSDm", "M1", "2024.01.01", "2025.01.01", "false", "3", "M1 NoFilter 2024"),
]
...
def wait_done(max_wait=720):
    start = time.time()
    time.sleep(30)  # M1 needs more time to process more bars
...
def main():
    ...
    md = [f"# M15 FAG v2.0 — M1 Timeframe Test", f"*Generated: {ts}*",
