...
void CreatePanel()
{
   ...
   string titleTxt = "Trading Panel v2.18";
...
void UpdatePanel()
{
   ...
   string panelTitle = "Trading Panel v2.18";
   if(g_panelCollapsed)
   {
      if(g_hasPos)
      {
...
int OnInit()
{
   ...
   Print(StringFormat("[PANEL] Tuan Quick Trade v2.18 | %s | Risk=$%.2f | SL=ATR | Trail=%s",
      _Symbol,
      InpDefaultRisk,
